...
class FirOverrideService(val session: FirSession) : FirSessionComponent {
    ...
    private fun isMoreSpecific(
        ...
        val aReturnType = returnTypeCalculator.tryCalculateReturnType(a.fir).type.let(substitutor::substituteOrSelf)
        val bReturnType = returnTypeCalculator.tryCalculateReturnType(b.fir).type
