...
abstract class IrSimpleType(kotlinType: KotlinType?) : IrTypeBase(kotlinType), SimpleTypeMarker, TypeArgumentListMarker {
    ...
    /**
     * If type is explicitly marked as nullable, [nullability] is [SimpleTypeNullability.NULLABLE]
     *
     ...
     *
     * In most cases on of following needed:
     *
     ...
     *
     * Use [IrType.makeNotNull] or [IrType.makeNullable] or [IrType.withNullability] to transfer nullability from one type to another
     */
    ...
    /**
     * This field is old API, which was very easy to misuse.
     *
     * For most cases one of utils function would be more suitable, than direct usage.
     *
     * Check [nullability] field documentation for details
     */
    @Deprecated(
    ...
    val hasQuestionMark: Boolean
        get() = nullability == SimpleTypeNullability.NULLABLE
}
