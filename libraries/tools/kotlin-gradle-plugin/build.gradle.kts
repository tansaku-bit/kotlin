...
dependencies {
    ...
    commonCompileOnly("com.android.tools.build:gradle:3.0.0") { isTransitive = false }
    commonCompileOnly("com.android.tools.build:gradle-core:3.0.0") { isTransitive = false }
    commonCompileOnly("com.android.tools.build:builder-model:3.0.0") { isTransitive = false }
